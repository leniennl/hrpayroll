...
SPECIFIED_DATE = pd.to_datetime('2022-07-01')

# Read the original spreadsheet with rate changing hisotry, exported from Payforce
HISTORY_DF = pd.read_csv(r"H:\RATE WITH HISTORY.CSV")
...
columns_to_keep = ['Employee code', 'Employee Name', 'CHANGE DATE', 'EFFECTIVE_DATE', 'Amount']
